...
Route::get('/profil','client@profilUserForm' )->name('profil');
Auth::routes();
...
Route::get('modifierprofilform,{id}','client@modifierprofileform')->name('modifierprofileform');
...
Route::get('rechercheview','ServicesController@viewrecherche')->name('rechercheview');
