                        ...
                        <div class="freelancer-overview">
                            <div class="freelancer-overview-inner">
                                ...
                                <div class="freelancer-name">
                                    <h4><a href="single-freelancer-profile.html">{{App\User::find($detail->id_users)->name}} <img class="flag" src="images/flags/gb.svg" alt="" title="United Kingdom" data-tippy-placement="top"></a></h4>
                        ...
                        <div class="freelancer-details">
                            <div class="freelancer-details-list">
                                <ul>
                                    ...
                                    <li>ype influence <strong>{{$detail->typeinfluencer}}</strong></li>
                                </ul>
                            </div>

                            <button type="button" data-toggle="modal" data-backdrop="false" data-target="#infos<?php echo $i;?>" class="button button-sliding-icon ripple-effect"><i class="icon-material-outline-arrow-right-alt"></i></a>View Profile</button>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Le Tigre (Panthera tigris) est un mammifère carnivore de la famille des félidés...<?php echo $i;?>
                                        </div>
